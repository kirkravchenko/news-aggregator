...
commands = [
    ...
    types.BotCommand(command=properties.URLS.mid_ru.name,
                     description=properties.Descriptions.mid_ru.value),
    ...
    types.BotCommand(command=properties.URLS.un_en.name,
                     description=properties.Descriptions.un_en.value),
    ...
    types.BotCommand(command=properties.URLS.guardian_gloabal_dev.name,
                     description=properties.Descriptions.guardian_gloabal_dev.value),
